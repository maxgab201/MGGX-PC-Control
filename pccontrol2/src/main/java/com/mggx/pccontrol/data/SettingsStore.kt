...
private val Context.dataStore by preferencesDataStore("mggx_pc_control2_legacy_settings")
...
class SecureTokenStore(context: Context) {
    private val prefs = context.getSharedPreferences("mggx_pc_control2_legacy_secure", Context.MODE_PRIVATE)
    private val alias = "mggx_pc_control2_legacy_relay_token_v1"
